# MCP Server Trello
[![smithery badge](https://smithery.ai/badge/@diegofornalha/mcp-server-trello)](https://smithery.ai/server/@diegofornalha/mcp-server-trello)
...
To install mcp-server-trello for Claude Desktop automatically via [Smithery](https://smithery.ai/server/@diegofornalha/mcp-server-trello):

```bash
npx -y @smithery/cli install @diegofornalha/mcp-server-trello --client claude
```
